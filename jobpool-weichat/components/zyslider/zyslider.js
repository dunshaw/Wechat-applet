var util = require('../../utils/zyslider')
      ...
      methods: {
        ...
        */
        ...
        _minMove: function (e) {
          ...
          var timer = that.data.lefttimer
          clearTimeout(timer) 
          timer = setTimeout(function () {
            that.triggerEvent('lowValueChange', lowValue)
          }, 500)
          that.setData({
            lefttimer:timer
          })
        ...
        _maxMove: function (e) {
          ...
          var timer = that.data.righttimer
          clearTimeout(timer) 
          timer = setTimeout(function () {
            that.triggerEvent('heighValueChange', heighValue)
          }, 500)
          that.setData({
            righttimer:timer
          })
